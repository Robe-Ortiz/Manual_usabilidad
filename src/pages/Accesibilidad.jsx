...
function Accesibilidad() {
  return (
    <div className="p-4">
      <h2 className='text-3xl font-bold mb-10 text-green-800 text-center'>2. Accesibilidad y Diseño Inclusivo</h2>

      <section className="mb-6 bg-green-100 p-4 rounded-md">
        <h3 className="text-2xl font-semibold mb-2 text-center text-green-800">Uso de etiquetas <code>accessibilityLabel</code></h3>
      ...
      <section className="mb-6 bg-green-100 p-4 rounded-md">
        <h3 className="text-2xl font-semibold mb-2 text-center text-green-800">Contrastes de color adecuados</h3>
      ...
      <section className="mb-6 bg-green-100 p-4 rounded-md">
        <h3 className="text-2xl font-semibold mb-2 text-center text-green-800">Fuentes legibles y escalabilidad</h3>
        <p className="text-base">
