...
function Introduccion() {
  return (
    <div className="p-4">
      <h2 className='text-3xl font-bold mb-10 text-green-800 text-center'>1. Introducción a la Usabilidad</h2>
      
      <section className="mb-6 bg-green-100 p-4 rounded-md">
        <h3 className="text-2xl font-semibold mb-2 text-center text-green-800">¿Qué es la usabilidad?</h3>
      ...
      <section className="mb-6 bg-green-100 p-4 rounded-md">
  <h3 className="text-2xl font-semibold mb-2 text-center text-green-800">Principios básicos</h3>
  <ul className="list-disc pl-5 list-inside marker:text-green-800">
    ...
    <li><span className="font-semibold text-green-600">Satisfacción del usuario</span>: La experiencia debe ser agradable y no generar frustración.</li>
      ...
      <section className="mb-6 bg-green-100 p-4 rounded-md">
        <h3 className="text-2xl font-semibold mb-2 text-center text-green-800">Diferencias entre UX y UI</h3>
