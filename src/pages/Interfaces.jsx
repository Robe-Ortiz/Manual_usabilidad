...
function Interfaces() {
    return (
        <div className="p-4">
          <h2 className='text-3xl font-bold mb-10 text-green-800 text-center'>3. Diseño de Interfaces (UI) Eficientes</h2>
    
          <section className="mb-6 bg-green-100 p-4 rounded-md">
            <h3 className="text-2xl font-semibold mb-2 text-center text-green-800">Botones y tamaño táctil recomendado</h3>
          ...
          <section className="mb-6 bg-green-100 p-4 rounded-md">
            <h3 className="text-2xl font-semibold mb-2 text-center text-green-800">Espaciado y alineación</h3>
          ...
          <section className="mb-6 bg-green-100 p-4 rounded-md">
            <h3 className="text-2xl font-semibold mb-2 text-center text-green-800">Animaciones y retroalimentación visual</h3>
            <p className="text-base">
