...
function Practicas() {
    return (
        <div className="p-4">
          <h2 className='text-3xl font-bold mb-10 text-green-800 text-center'>5. Buenas Prácticas en Desarrollo de Apps Usables</h2>
    
          <section className="mb-6 bg-green-100 p-4 rounded-md">
            <h3 className="text-2xl font-semibold mb-2 text-center text-green-800">Evitar sobrecarga cognitiva</h3>
          ...
          <section className="mb-6 bg-green-100 p-4 rounded-md">
            <h3 className="text-2xl font-semibold mb-2 text-center text-green-800">Minimizar tiempo de espera</h3>
            <p className="text-base">
          ...
          <section className="mb-6 bg-green-100 p-4 rounded-md">
            <h3 className="text-2xl font-semibold mb-2 text-center text-green-800">Uso eficiente de notificaciones y alertas</h3>
            <p className="text-base">
